...
//
// Output data is stored in the input directory in files called <Prefix>_CurvatureResData_<curvature type>.txt
// and <Prefix>_<Resolution>_Hist_<Curvature Type>.txt
...
int main(int nNumberofArgs, char *argv[])
{
  ...
  for (int a = 0; a < 10; ++a){
    ...
    stringstream ss3;
    ss3 << path << Prefix << "_" << Resolutions[a] << "_Hist_" << Curvature_Type << ".txt";
